  ...
  return (
    <PageArea>
      ...
      <PageTextSection title="社團簡介">
        <p>
          台大TED分享社是一個由學生組成，並積極和自身與社會現狀有所感的人共同開展公民教育討論的組織。我們以社團名義規劃展覽、沙龍、工作坊等TED理念推廣活動，並於每年五月舉辦由TED大會官方授權的TEDxNationalTaiwanUniversity年會，至今已邁入第七屆。我們期待透過我們辦理的種種活動，與每個觀眾一同在與自己和社會對話的過程中探索，嘗試釐清社會中複雜現象背後的本質，加深對公民教育的認識。
        </p>
      </PageTextSection>
